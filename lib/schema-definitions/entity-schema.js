...
function _indexRelations() {
	...
	var filterDuplicates = function filterDuplicates(el, i, a) {
...
var indexRelations = function indexRelations(o, propertyDefinitions) {
	var index = {};
...
var index = function index(o, propertyDefinitions) {
...
var EntitySchema = function () {
  ...
  */
   ...
   */
		...
		key: 'getAttributesByName',
		value: function getAttributesByName() {
   ...
   */
		...
		key: 'getRelationshipsByName',
		value: function getRelationshipsByName() {
   ...
   */
		...
		key: 'getFetchedByName',
		value: function getFetchedByName() {
   ...
   */
		...
		key: 'getRequiredByName',
		value: function getRequiredByName() {
   ...
   */
		...
		key: 'getTransientByName',
		value: function getTransientByName() {
   ...
   */
		...
		key: 'getPropertiesByName',
		value: function getPropertiesByName() {
   ...
   */
		...
		key: 'getPropertyWithName',
		value: function getPropertyWithName(name) {
   ...
   */
		...
		key: '_addAffectedProperty',
		value: function _addAffectedProperty(e1, p1, e2, p2) {
			var m = this.model;
		...
		key: 'getPropertiesAffecting',
		value: function getPropertiesAffecting(affectedProperty) {
			return this.getProperties().filter(function (property) {
				return property.affects(affectedProperty);
			});
		}
	}, {
		key: 'getPropertiesAffectedBy',
		value: function getPropertiesAffectedBy(affectingProperty) {
			return this.getProperties().filter(function (property) {
