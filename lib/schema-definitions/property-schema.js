...
var TypeValidators = {
	...
	'date': function date(value) {
		return (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && !!value && value.constructor.name === 'Date';
	}
};
