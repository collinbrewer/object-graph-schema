...
describe('ObjectGraphSchema', function () {
	...
	context('Indexing', function () {
		var objectGraph = new ObjectGraphSchema({
			'schemaType': 'object-graph',
			'entities': [{
				'schemaType': 'entity',
				'name': 'Person',
		...
		it('should index all relationships', function () {
			var index = objectGraph.getIndex();
			var personIndex = index.entitiesByName.Person.index;
			var businessIndex = index.entitiesByName.Business.index;
